...
public sealed partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        InitializeComponent();
        Title = "Downlism 安裝程式";
        AppWindow.SetIcon(Path.Combine(AppContext.BaseDirectory, "Assets", "Downlism.ico"));
        ...
        {
            Heading.Text = "更新 Downlism";
            Description.Text = "直接更新目前安裝，保留設定、使用紀錄與登入啟動設定。";
            Details.Text = "執行中的 Downlism 會自動關閉，不需要手動退出。只替換有變動的檔案；更新失敗會嘗試回復原檔案。";
            InstallPath.IsReadOnly = true;
    ...
    private async void ActionClick(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            Description.Text = _uninstall ? "Downlism 已從這台電腦的安裝位置移除。" : "開啟 Downlism 貼上網址，或在瀏覽器載入擴充功能後直接下載。";
            ...
            Status.Message = _uninstall
                ...
                : "從開始功能表開啟，或按下方按鈕開始使用。";
            Status.IsOpen = true;
            ActionButton.Content = _uninstall ? "完成" : "開啟 Downlism";
