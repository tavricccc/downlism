...
/// </summary>
/// <remarks>
/// Everything Downlism installs used to sit in a <c>resources</c> folder beside the setup
...
internal static class Payload
{
    ...
    private static readonly byte[] Magic = "DOWNLISM-PAYLOAD"u8.ToArray();

    private const int TrailerLength = 8 + 16;
