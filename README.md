...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.6.0-0A84FF?style=flat-square" alt="Version 0.6.0" />
...
**下載前可以選影片或 MP3，也可以限制畫質或音訊位元率。** 影片可選最佳畫質或 2160p 至 360p；音訊可選最佳品質或 320 至 128 kbps。選擇會跟著暫停的項目保存，重開程式後再繼續也不會改回預設值。
